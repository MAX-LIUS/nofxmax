...
func TestDetectUnexpectedProtectionOrdersFlagsUnplannedStopsAndTakeProfits(t *testing.T) {
	...
	unexpectedSL, unexpectedTP := detectUnexpectedProtectionOrders(openOrders, "LONG", plan, breakEvenArmedOnly(false), nativeTrailingArmedOnly(false))
	if unexpectedSL != 1 {
...
func TestDetectUnexpectedProtectionOrdersAllowsBreakEvenAndTrailingWhenArmed(t *testing.T) {
	...
	unexpectedSL, unexpectedTP := detectUnexpectedProtectionOrders(openOrders, "LONG", plan, breakEvenArmedOnly(true), nativeTrailingArmedOnly(true))
