...
func TestDetectMissingProtectionRequiresLadderStopsDespiteTaggedFallbackPriceDrift(t *testing.T) {
	...
	ownership := evaluateProtectionOwnership(orders, "LONG", plan, breakEvenArmedOnly(false), nativeTrailingArmedOnly(false))
...
func TestDetectUnexpectedProtectionOrdersDoesNotCountMatchingFallbackAsUnexpected(t *testing.T) {
	...
	unexpectedSL, unexpectedTP := detectUnexpectedProtectionOrders(orders, "SHORT", plan, breakEvenArmedOnly(false), nativeTrailingArmedOnly(false))
