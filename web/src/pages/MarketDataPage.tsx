    ...
    <>
      ...
      <div className="fixed inset-4 md:inset-8 bg-zinc-900 border border-zinc-700 rounded-xl z-50 flex flex-col overflow-hidden shadow-2xl">
        ...
        <div className="flex items-center justify-between px-6 py-3 border-b border-zinc-800 shrink-0">
          ...
          <button
            onClick={onClose}
            className="px-3 py-1.5 rounded-lg text-sm font-medium text-zinc-400 hover:text-white hover:bg-zinc-800 transition-all border border-zinc-700"
          >
            ✕ 关闭
          </button>
        </div>
        ...
        <div className="flex flex-1 min-h-0">
          {/* Left: Coin details */}
          <div className="w-80 shrink-0 border-r border-zinc-800 overflow-y-auto p-4 space-y-4">
            {loading ? (
