...
export const translations = {
  en: {
    ...
    strategyStudio: {
      ...
      breakoutTrading: 'Breakout Trading',
      breakoutTradingDesc:
        'Data-validated breakout edge with AI soft-veto sizing',
      breakoutConfig: 'Breakout Configuration',
      breakoutTimeframe: 'Timeframe',
      breakoutLookback: 'Lookback Bars',
      breakoutLeverage: 'Leverage',
      breakoutSizeFrac: 'Size (fraction of equity)',
      coinSource: 'Coin Source',
      indicators: 'Indicators',
    ...
    traderDashboard: {
      ...
      confirmBatchClose: 'Close {count} selected position(s) at market price?',
      batchCloseDone: 'Closed {count} position(s)',
      batchClosePartial: 'Closed {ok}, failed {failed}',
  ...
  zh: {
    ...
    strategyStudio: {
      ...
      gridConfig: '网格配置',
      breakoutTrading: '突破交易',
      breakoutTradingDesc: '数据验证的突破策略，AI 仅做软否决缩仓',
      breakoutConfig: '突破配置',
      breakoutTimeframe: '时间周期',
      breakoutLookback: '回看 K 线数',
      breakoutLeverage: '杠杆',
      breakoutSizeFrac: '仓位（权益占比）',
      coinSource: '币种来源',
      indicators: '技术指标',
      riskControl: '风控参数',
    ...
    traderDashboard: {
      ...
      positionClosed: '平仓成功',
      closeFailed: '平仓失败',
      confirmBatchClose: '确定按市价平掉选中的 {count} 个仓位吗？',
      batchCloseDone: '已平仓 {count} 个',
      batchClosePartial: '成功 {ok} 个，失败 {failed} 个',
      selectAll: '全选',
      closeSelected: '平仓选中',
      hideAddress: '隐藏地址',
  ...
  id: {
    ...
    strategyStudio: {
      ...
      breakoutTrading: 'Breakout Trading',
      breakoutTradingDesc:
        'Edge breakout tervalidasi data dengan AI soft-veto sizing',
      breakoutConfig: 'Konfigurasi Breakout',
      breakoutTimeframe: 'Timeframe',
      breakoutLookback: 'Bar Lookback',
      breakoutLeverage: 'Leverage',
      breakoutSizeFrac: 'Ukuran (fraksi ekuitas)',
      coinSource: 'Sumber Koin',
      indicators: 'Indikator',
